...
//    }
     ...
     */
    public TestFurnaceContainerMenu(final int windowId, final Inventory playerInventory, final BlockPos pos) 
    {
        ...
        super(ModMenuTypes.test_furnace.get(), windowId, pos, playerInventory, playerInventory.player, RecipeType.SMELTING);
